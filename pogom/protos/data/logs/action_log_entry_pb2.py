...
_ACTIONLOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='open_gift', full_name='pogoprotos.data.logs.ActionLogEntry.open_gift', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='send_gift', full_name='pogoprotos.data.logs.ActionLogEntry.send_gift', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='trading', full_name='pogoprotos.data.logs.ActionLogEntry.trading', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='share_ex_raid_pass', full_name='pogoprotos.data.logs.ActionLogEntry.share_ex_raid_pass', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='decline_ex_raid_pass', full_name='pogoprotos.data.logs.ActionLogEntry.decline_ex_raid_pass', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fitness_rewards', full_name='pogoprotos.data.logs.ActionLogEntry.fitness_rewards', index=15,
