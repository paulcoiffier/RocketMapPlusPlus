...
_POKEMONSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_transferable', full_name='pogoprotos.settings.master.PokemonSettings.is_transferable', index=34,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_deployable', full_name='pogoprotos.settings.master.PokemonSettings.is_deployable', index=35,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_tradable', full_name='pogoprotos.settings.master.PokemonSettings.is_tradable', index=36,
