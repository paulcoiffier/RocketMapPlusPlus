...
# source: pogoprotos/networking/platform/telemetry/platform_metric_data.proto
...
from pogoprotos.networking.platform.telemetry import distribution_pb2 as pogoprotos_dot_networking_dot_platform_dot_telemetry_dot_distribution__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pogoprotos/networking/platform/telemetry/platform_metric_data.proto',
...
_PLATFORMMETRICDATA_KIND = _descriptor.EnumDescriptor(
  name='Kind',
  full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.Kind',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PLATFORMMETRICDATA = _descriptor.Descriptor(
  ...
  full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='common_telemetry', full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.common_telemetry', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='long_value', full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.long_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='double_value', full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.double_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='boolean_value', full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.boolean_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='distribution', full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.distribution', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_kind', full_name='pogoprotos.networking.platform.telemetry.PlatformMetricData.metric_kind', index=5,
...
PlatformMetricData = _reflection.GeneratedProtocolMessageType('PlatformMetricData', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.platform.telemetry.platform_metric_data_pb2'
  # @@protoc_insertion_point(class_scope:pogoprotos.networking.platform.telemetry.PlatformMetricData)
  ))
