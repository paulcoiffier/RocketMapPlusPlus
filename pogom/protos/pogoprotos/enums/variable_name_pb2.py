...
_VARIABLENAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BGMODE_OFF_SESSION_DISTANCE_KM', index=37, number=1030,
      serialized_options=None,
      type=None),
  ],
