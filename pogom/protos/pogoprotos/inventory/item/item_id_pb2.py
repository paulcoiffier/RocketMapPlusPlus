...
_ITEMID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_MOVE_REROLL_FAST_ATTACK', index=41, number=1201,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_MOVE_REROLL_SPECIAL_ATTACK', index=42, number=1202,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_RARE_CANDY', index=43, number=1301,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_FREE_RAID_TICKET', index=44, number=1401,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_PAID_RAID_TICKET', index=45, number=1402,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_LEGENDARY_RAID_TICKET', index=46, number=1403,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_STAR_PIECE', index=47, number=1404,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_FRIEND_GIFT_BOX', index=48, number=1405,
      serialized_options=None,
      type=None),
  ],
